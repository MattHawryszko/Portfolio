      ...
      <section id="about">
        <div className="py-5 row">
            ...
            <div className="col-md-6 col-12">
              <h2 className="wow bounceIn py-5 text-center text-uppercase text-blue">About Me<div className="mx-auto dash-small"></div></h2>
              <div className="my-auto wow bounceIn ">
