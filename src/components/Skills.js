        ...
        <div className="container">
          ...
          <div className="row pb-5 justify-content-center">
              <div className="col-lg-4 col-md-6 pb-2">
                ...
                <h6 className="text-blue text-center">Front-end Web development<div class="mt-1 dash-xs mx-auto"></div></h6>
              ...
              <div className="col-lg-4 col-md-6 pb-2">
                ...
                <h6 className="text-blue text-center">Back-end Web development<div class="mt-1 dash-xs mx-auto"></div></h6>
              ...
              <div className="col-lg-4 col-md-4 pb-2">
                ...
                <h6 className="text-blue text-center">Development Tools<div class="mt-1 dash-xs mx-auto"></div></h6>
